...
public class TesteUsuario {
	...
	public void setUp(){
		...
		usuario3 = new Usuario("mariadoida", "987", "Maria", "maria@sememail.com");
		usuario4 = new Usuario("barbarara", "huhu5", "Barbara", "barbara@sememail.com");
	...
	public void testaOrdenaListaSeguidores() throws Exception{
		...
		Assert.assertEquals(usuario4.getNome(), usuario1.getListaDeSeguidores().get(0).getNome());
		Assert.assertEquals(usuario2.getNome(), usuario1.getListaDeSeguidores().get(1).getNome());
		Assert.assertEquals(usuario3.getNome(), usuario1.getListaDeSeguidores().get(2).getNome());
	}
