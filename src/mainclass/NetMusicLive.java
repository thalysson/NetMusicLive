...
public class NetMusicLive implements Serializable {
	...
	/**
	 * Todos os dados do sistema Ã¡ zerado. Utilizado tambÃ¡m para instaciar as
	 ...
	 * 
	 * @param login
	 *            Login do usuario que terÃ¡ a sessao encerrada.
	 */
	...
	public Usuario getUsuario(String valorLoginOuId,String loginOuId){
		return this.gerenciador.getUsuario(valorLoginOuId, loginOuId);
	}
